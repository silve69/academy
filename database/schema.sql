...
CREATE TABLE sport_groups (
  ...
  CONSTRAINT fk_sport_groups_coach FOREIGN KEY (coach_user_id) REFERENCES users(id) ON DELETE SET NULL,
...
GROUP BY sg.id, sp.name, sg.name, sg.level, sg.capacity, u.name;
